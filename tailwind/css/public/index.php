...
<html lang="en" dir="ltr">
  ...
  <body class="text-green-900">
    <div class="">
      ...
      <div class="w-full h-96 relative border-2 group">
        <img src="images/law.png" class="h-full w-full object-cover absolute mix-blend-overlay bg-blue-400 group-hover:blur">
        <div class="p-5">
      ...
      <div class="w-full h-96 relative border-2 group">
        <img src="images/pay.jpg" class="h-full w-full object-cover absolute mix-blend-overlay bg-blue-400 group-hover:blur">
        <div class="p-5">
            <h1 class="text-black text-2xl sm:text-6xl font-body">VetCares</h1>

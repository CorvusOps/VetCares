  ...
  <?php include 'clientsidebar.html' ?>
      ...
      <table class="border-2 border-blue-800 m-auto md:mt-20 md:ml-56 md:mr-4 w-9/12 text-left border-collapse lg:ml-60">
        ...
        <tr class="border-2 border-blue-800">
          ...
          <th class="w-1/5 border-2 border-blue-800">Height</th>
          <th class="w-1/5 border-2 border-blue-800">Weight</th>
        ...
        <tr>
          ...
          <td class="border-2 border-blue-800">tall boiii</td>
          <td class="border-2 border-blue-800">phat boiiii</td>
